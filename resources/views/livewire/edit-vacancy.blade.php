<form action="" method="post" class="md:w-1/2 space-y-4" wire:submit.prevent="editVacancy">
    <div>
        <x-input-label
            for="title"
    ...
    <div>
        ...
        <div class="my-5 w-72">
            <x-input-label
                for="image"
                :value="__('Current image')"
            />
            <img src="{{ asset('storage/vacancies/' . $image) }}" alt="{{ 'Image vacancy ' . $title }}">
        </div>
